...
for (let digit=0; digit<digits; digit+=1) {
    ...
    <div class="sorobanRow" id="sb_`+digit.toString()+`">
        <button onclick="subt5('sbt_`+digit.toString()+`')">&#9651</button>
        <img draggable="false" class="sorobanTop" id="sbt_`+digit.toString()+`" />
        <button onclick="add5('sbt_`+digit.toString()+`')">&#9661</button>
        
        <div class="vPadding"></div>
        
        <button onclick="add1('sbb_`+digit.toString()+`')">&#9651</button>
        <img draggable="false" class="sorobanBottom" id="sbb_`+digit.toString()+`" />
        <button onclick="subt1('sbb_`+digit.toString()+`')">&#9661</button>
    </div>`
    soroban += sorobanRow;
