...
for (let suanpanDigit=0; suanpanDigit<suanpanDigits; suanpanDigit+=1) {
	...
	elemSelector("#suanpanAbacusValue").innerHTML = "中式算盤的值： 0";
}
...
let suanpanMatch = function() {
	...
	checksuanpanMatch = setInterval(function() {
		if (suanpanValDisplayNum == rn.toString()) {
			...
			suanpanMatches += 1;
			elemSelector("#suanpanMatchSuccess").innerHTML = "好了!";
			elemSelector("#suanpanMatchResult").innerHTML = "匹配数: " + suanpanMatches;
