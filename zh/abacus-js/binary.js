...
let binaryMatch = function() {
	...
	checkBinaryMatch = setInterval(function() {
		if (binaryValDisplayNum == rnBinary.toString()) {
			...
			binaryMatches += 1;
			elemSelector("#binaryMatchSuccess").innerHTML = "好了!";
			elemSelector("#binaryMatchResult").innerHTML = "匹配数: " + binaryMatches;
			clearInterval(checkBinaryMatch);
		}
	}, 100)
	elemSelector("#binaryMatchNumber").innerHTML = "算盘练习 - 置算盘的值为 " + rnBinary.toString();
};
